...
> This is a starter kit to quickly create a Markdown-based open publishing site with [Docsify](https://docsify.js.org). Global navigation elements can be hidden for seamlessly embedding pages into other platforms. Includes an optional "Edit this Page" link.
